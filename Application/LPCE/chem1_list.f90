MODULE chem1_list
  ...
  CHARACTER(LEN=24),PARAMETER :: chemical_mechanism='LPCE'
...
!     Referencias: Barth et al. JGR 112, D13310 2007
  ...
  INTEGER,PARAMETER :: nr   =003!Number of gas-phase reactions
  INTEGER,PARAMETER :: nrt  =003!Total Number of reactions
